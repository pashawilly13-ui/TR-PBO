...
import model.Dosen;
import controller.HomeDosenController; 
...
public class HomeDosen extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(HomeDosen.class.getName());
    
    private final String nidnDosen; 
    private final HomeDosenController controller;

    public HomeDosen(String nidn) {
        this.nidnDosen = nidn;
        initComponents();
        logger.info("View HomeDosen diinisialisasi untuk NIDN: " + nidn);
        
        this.controller = new HomeDosenController(this, nidn);
    ...
    public javax.swing.JButton getBtnDaftarMahasiswa() {
        return btnDaftarMahasiswa;
    }
    ...
    public void tampilkanDataProfil(Dosen dsn) {
        if (dsn != null) {
            txtNama.setText(dsn.getNama());
            txtNidn.setText(dsn.getNidn());
            txtEmail.setText(dsn.getEmail());
            txtNoHandphone.setText(dsn.getNoHandphone());
            txtProgramStudi.setText(dsn.getProgramStudi());
            
            txtNidn.setEditable(false);
            
            logger.info("Data profil Dosen " + dsn.getNidn() + " berhasil ditampilkan.");
        } else {
            txtNama.setText("Data Profil Dosen Tidak Ditemukan.");
    ...
    private void initComponents() {
        ...
        btnDaftarMahasiswa.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(btnDaftarMahasiswa, javax.swing.GroupLayout.DEFAULT_SIZE, 125, Short.MAX_VALUE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(btnDaftarMahasiswa, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txtProgramStudi))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(jLabel5)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txtNoHandphone, javax.swing.GroupLayout.PREFERRED_SIZE, 135, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel2Layout.createSequentialGroup()
    ...
    public static void main(String args[]) {
        ...
        final String NIDN_DUMMY = "0401018"; // Ganti dengan NIDN yang ada di DB Anda
        
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                // Sekarang kita memanggil constructor yang benar, dengan argumen String
                new HomeDosen(NIDN_DUMMY).setVisible(true); 
            }
        });
    }
